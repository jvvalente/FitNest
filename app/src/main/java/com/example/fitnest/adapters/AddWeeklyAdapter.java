...
import com.example.fitnest.WeeklyPlanItem;

import java.util.ArrayList;

public class AddWeeklyAdapter extends RecyclerView.Adapter<AddWeeklyAdapter.ViewHolder>{
    Context context;
    private ArrayList<WeeklyPlanItem> exerciseList;

    public AddWeeklyAdapter(ArrayList<WeeklyPlanItem> exerciseList){
